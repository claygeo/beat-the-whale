...
**NEXT:**
1. **`/qa-design-review` polish pass** — audit mobile 375px + X in-app webview (390x550) against DESIGN.md; tighten spacing/contrast/touch-target nits. (RaceLane + mark-to-market already verified across all 3 viewports this pass.)
