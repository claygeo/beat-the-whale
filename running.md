...
**NEXT — ship-ready gate:**
1. Final full **`/qa`** functional pass on BOTH modes (whale: daily/featured/sample/wallet/ranked-submit; arcade: all 4 events/speed/high-score/result) + **`/review`** + **codex pre-landing** review of the diff since the taste overhaul.
2. README refresh (two modes, how it works) + launch asset (10s screen-rec GIF + X copy).
